...
To all of you who have contributed to Davtrax over the years:
**Thank you!**
...
[![Gitter](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/olefredrik/davtrax?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge)
[![GitHub version](https://badge.fury.io/gh/olefredrik%2Fdavtrax.svg)](https://github.com/olefredrik/Davtrax/releases)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

This is a starter-theme for WordPress based on Zurb's [Foundation for Sites 6](https://foundation.zurb.com/sites.html), the most advanced responsive (mobile-first) framework in the world. The purpose of Davtrax, is to act as a small and handy toolbox that contains the essentials needed to build any design. Davtrax is meant to be a starting point, not the final product.
...
Davtrax uses [Sass](http://Sass-lang.com/) (CSS with superpowers). In short, Sass is a CSS pre-processor that allows you to write styles more effectively and tidy.

The Sass is compiled using libsass, which requires the GCC to be installed on your machine. Windows users can install it through [MinGW](http://www.mingw.org/), and Mac users can install it through the [Xcode Command-line Tools](http://osxdaily.com/2014/02/12/install-command-line-tools-mac-os-x/).

If you have not worked with a Sass-based workflow before, I would recommend reading [Davtrax for beginners](https://davtrax.olefredrik.com/posts/tutorials/davtrax-for-beginners), a short blog post that explains what you need to know.
...
$ git clone https://github.com/olefredrik/Davtrax.git
$ cd Davtrax
$ npm install
```
...
#### YAML config file
Davtrax includes a `config-default.yml` file. To make changes to the configuration, make a copy of `config-default.yml` and name it `config.yml` and make changes to that file. The `config.yml` file is ignored by git so that each environment can use a different configuration with the same git repo.
...
* [Clean Davtrax install](http://davtrax.olefredrik.com/)
* [Davtrax Kitchen Sink - see every single element in action](http://davtrax.olefredrik.com/kitchen-sink/)
...
* [Davtrax for beginners](https://davtrax.olefredrik.com/posts/tutorials/davtrax-for-beginners/)
...
1. [Star](https://github.com/olefredrik/Davtrax/stargazers) the project!
2. Answer questions that come through [GitHub issues](https://github.com/olefredrik/Davtrax/issues)
3. Report a bug that you find
4. Share a theme you've built on top of Davtrax
5. [Tweet](https://twitter.com/intent/tweet?original_referer=http%3A%2F%2Fdavtrax.olefredrik.com%2F&text=Check%20out%20Davtrax%2C%20the%20ultimate%20%23WordPress%20starter-theme%20built%20on%20%23Foundation%206&tw_p=tweetbutton&url=http%3A%2F%2Fdavtrax.olefredrik.com&via=olefredrik) and [blog](http://www.justinfriebel.com/my-first-experience-with-davtrax-a-wordpress-starter-theme-106/) your experience of Davtrax.
