...
if ( ! function_exists( 'davtrax_asset_path' ) ) :
	function davtrax_asset_path( $filename ) {
...
if ( ! function_exists( 'davtrax_scripts' ) ) :
	function davtrax_scripts() {
	...
	add_action( 'wp_enqueue_scripts', 'davtrax_scripts' );
endif;
