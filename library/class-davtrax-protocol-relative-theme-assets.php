...
if ( ! class_exists( 'Davtrax_Protocol_Relative_Theme_Assets' ) ) :
	class Davtrax_Protocol_Relative_Theme_Assets {
		/**
	...
	$davtrax_protocol_relative_theme_assets = new Davtrax_Protocol_Relative_Theme_Assets;
endif;
