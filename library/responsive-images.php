...
function davtrax_custom_sizes( $sizes ) {
	return array_merge(
		$sizes, array(
...
add_filter( 'image_size_names_choose', 'davtrax_custom_sizes' );

// Add custom image sizes attribute to enhance responsive image functionality for content images
function davtrax_adjust_image_sizes_attr( $sizes, $size ) {
...
add_filter( 'wp_calculate_image_sizes', 'davtrax_adjust_image_sizes_attr', 10, 2 );
